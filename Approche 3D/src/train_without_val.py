...
from train import train_without_evaluation
...
dataset = HippocampusDataset(csv_file=csv_path, split="train+val")
...
best_model_state, history = train_without_evaluation(
    model, train_loader, num_epochs=args.epochs,
